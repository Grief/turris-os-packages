...
define ReForisTranslation
 ...
 define Package/reforis-shield-l10n-$(1)
	TITLE:=reforis-shield-l10n-$(1)
	DEPENDS:=\
		+reforis-shield
	MAINTAINER:=CZ.NIC <packaging@turris.cz>
 endef

 define Package/reforis-shield-l10n-$(1)/install
 ...
 define Package/reforis-shield-l10n-$(1)/postrm
#!/bin/sh
[ -n "$$$${IPKG_INSTROOT}" ] || /etc/init.d/lighttpd restart
 endef

 define Package/reforis-shield-l10n-$(1)/postinst
#!/bin/sh
[ -n "$$$${IPKG_INSTROOT}" ] || /etc/init.d/lighttpd restart
 endef

 $$(eval $$(call BuildPackage,reforis-shield-l10n-$(1)))
endef
